...
describe("postcss", () => {
	...
	it("properly transforms css", async () => {
		const css = fs.readFileSync(
			path.join(__dirname, "__fixtures__", "styleguide.css")
		);
	...
	it("transforms mixins properly", async () => {
		const css = fs.readFileSync(
			path.join(__dirname, "__fixtures__", "mixins.css")
		);
	...
	it("transforms accordion.css properly", async () => {
		const css = fs.readFileSync(
			path.join(__dirname, "__fixtures__", "accordion.css")
		);
	...
	it("transforms nesting.css properly", async () => {
		const css = fs.readFileSync(
			path.join(__dirname, "__fixtures__", "nesting.css")
		);
