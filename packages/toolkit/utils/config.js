...
const getDSScriptsConfig = () => {
	...
	const config = packageJson['digitalsilk-toolkit'] || packageJson['@digitalsilk/scripts'];
...
/**
 * Returns digitalsilk-toolkit configs for package builds. If digitalsilk-toolkit is not configured for building packages,
 * this returns false.
 *
